...
namespace Encountify.Services
{
    public class LocationDataStore : IDataStore<Location>
    {
        ...
        public List<Location> DummyLocationList()
        {
            ...
            {
                new Location() { Name = "Vilniaus katedra", CoordX = 54.685849042698216, CoordY = 25.287750880122083 },
                new Location() { Name = "Gedimino bokštas", CoordX = 54.68667445192699, CoordY = 25.29056883194689 },
                new Location() { Name = "Vilniaus Šv. Onos bažnyčia", CoordX = 54.68378573230062, CoordY = 25.292650881640785 },
                new Location() { Name = "Trys kryžiai", CoordX = 54.68740766559662, CoordY = 25.29771489238211 },
                new Location() { Name = "Gedimino prospektas", CoordX = 54.68644019450281, CoordY = 25.285441103636185 },
                new Location() { Name = "Lietuvos Respublikos Prezidento kanceliarija", CoordX = 54.68383535000863, CoordY = 25.286685648648888 },
                new Location() { Name = "Sereikiškių parko Bernardinų sodas", CoordX = 54.68413305498285, CoordY = 25.29522580235671 },
                new Location() { Name = "Lietuvos nacionalinis dailės muziejus", CoordX = 54.68130476957157, CoordY = 25.289818468853266 },
                new Location() { Name = "Užupio angelas", CoordX = 54.68035, CoordY = 25.29515}
            };
        }
